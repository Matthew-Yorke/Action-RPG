...
//
//***************************************************************************************************************************************************
Camera::Camera(RectangleObject* pTheBoundaries, Object* pTheObject)
{
   mCoordinateX = 0;
   mCoordinateY = 0;
   mpBoundaries = pTheBoundaries;
   mpFollowingObject = pTheObject;
...
//
//***************************************************************************************************************************************************
void Camera::ChangeFollowingObject(Object* pTheObject)
{
   mpFollowingObject = pTheObject;
   Update();
}
...
//
//***************************************************************************************************************************************************
void Camera::SetBoundaries(RectangleObject* pTheBoundaries)
{
   mpBoundaries = pTheBoundaries;
}
